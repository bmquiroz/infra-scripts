...
variable "management_subnet_suffix" {
  description = "Suffix to append to management subnets name"
  type        = string
  default     = "management"
}
...
variable "management_subnets" {
  description = "A list of management subnets inside the VPC"
  type        = list(string)
  default     = []
}
